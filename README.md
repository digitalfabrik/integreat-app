...
* Install Prettier Plugin (inteillij should recogzie everything and format code on save, if not got to Settings -> Languages and Framworks | Javascript | Prettier and select the installed prettier package)
