...
Therefore, you can follow the documentation for Manual Builds to set [certificates for iOS](06-manual-builds.md#manually-building-for-ios) and [keystores for Android](06-manual-builds.md#manually-building-for-android).
