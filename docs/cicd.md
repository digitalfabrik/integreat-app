...
| CREDENTIALS_KEYSTORE_PATH      | Path to the OpenSSL AES256-CBC encrypted Java Keystore file                                                | -                                                                        | ~/credentials/<secret>.enc          | Look for the `openssl enc` command in the Android Fastlane file for more information                   |
