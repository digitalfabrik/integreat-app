...
const browserstackCaps = (
  config: Capabilities.AppiumCapabilities &
    (Capabilities.AppiumAndroidCapabilities | Capabilities.AppiumXCUITestCapabilities),
...
} as Record<string, Capabilities.BrowserStackCapabilities>
