...
import { RegionModel, LanguageModelBuilder } from 'shared/api'
...
describe('NavigationTabs', () => {
  ...
  it('should be empty if all other header items are disabled', () => {
    const { getByText } = renderWithRouterAndTheme(
      <NavigationTabs languageCode={languageCode} regionModel={regionModel(false, false, false, false)} />,
    )
  ...
  it('should show categories if events are enabled', () => {
    const { getByText } = renderWithRouterAndTheme(
      <NavigationTabs languageCode={languageCode} regionModel={regionModel(true, false, false, false)} />,
    )
  ...
  it('should show categories if news are enabled', () => {
    const { getByText } = renderWithRouterAndTheme(
      <NavigationTabs languageCode={languageCode} regionModel={regionModel(false, false, false, true)} />,
    )
