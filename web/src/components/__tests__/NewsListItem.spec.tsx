...
import NewsListItem, { NUM_OF_CHARS_ALLOWED_LARGE_SCREEN } from '../NewsListItem'
...
describe('NewsListItem', () => {
  ...
  it('should show all the relevant information', () => {
    ...
    expect(getByText(textTruncator(message, NUM_OF_CHARS_ALLOWED_LARGE_SCREEN))).toBeTruthy()
