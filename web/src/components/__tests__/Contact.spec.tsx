...
describe('Contact', () => {
  ...
  it('should render correctly with all contact information', () => {
    ...
    const { getByText, getAllByText } = renderWithTheme(<Contact contact={contact} />)
    expect(getByText(contact.headline!)).toBeTruthy()
    expect(getAllByText('pois:website')).toBeTruthy()
  ...
  it('should render correctly without phone number', () => {
    ...
    const { getByText, queryByText, getAllByText } = renderWithTheme(<Contact contact={contact} />)
    expect(getByText(contact.headline!)).toBeTruthy()
    expect(getAllByText('pois:website')).toBeTruthy()
