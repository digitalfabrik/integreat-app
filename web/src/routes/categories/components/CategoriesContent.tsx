...
const CategoriesContent = ({
  ...
  if (categories.isLeaf(categoryModel)) {
    ...
    return <Page title={categoryModel.title} content={categoryModel.content} lastUpdate={categoryModel.lastUpdate} formatter={formatter} onInternalLinkClick={push} />;
  ...
  }))} category={categoryModel} onInternalLinkClick={push} formatter={formatter} />;
};
