...
describe('PoisPage', () => {
  const pois = [
    ...
    new PoiModel({
      ...
      title: 'second Event',
      availableLanguages: new Map([
        ['en', '/augsburg/de/locations/zwoter_poi'],
        ['ar', '/augsburg/ar/locations/zwoter_poi']
      ]),
      location: new LocationModel({
        name: 'name',
        address: 'address',
    ...
    new PoiModel({
      ...
      title: 'third Event',
      availableLanguages: new Map([
        ['de', '/augsburg/de/locations/dritter_poi'],
        ['ar', '/augsburg/ar/locations/dritter_poi']
      ]),
      location: new LocationModel({
        name: 'name',
        address: 'address',
  ...
  it('should render a Failure if poi is invalid', () => {
    expect(
      shallow(<PoisPage pois={pois} t={t} city={city} language={language} poiId='invalid_poi' />)
    ).toMatchSnapshot()
  })
  ...
  it('should sort the pois alphabetically', () => {
    const tree = shallow(
      <PoisPage pois={[pois[2], pois[1], pois[0]]} t={t} city={city} language={language} poiId={undefined} />
    )
