...
export const PoisPage = ({
  ...
  if (poiId) {
    ...
    if (poi) {
      ...
      return <Page defaultThumbnailSrc={poi.thumbnail} lastUpdate={poi.lastUpdate} content={poi.content} title={poi.title} formatter={formatter} onInternalLinkClick={push}>
...
export default connect<$Diff<PropsType, {
  t: TFunction;
}>, OwnPropsType, _, _, _, _>(mapStateTypeToProps, () => ({}))(withTranslation<PropsType>('pois')(PoisPage));