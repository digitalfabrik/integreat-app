...
const ListItemExplanation = styled(Typography)`
  font-size: 1rem;
  font-weight: 400;
`
  ...
  return (
    <Layout footer={<GeneralFooter language={languageCode} />}>
      <Container>
        ...
        <ListHeading variant='h2'>{t('whatToDo')}</ListHeading>
        <ListItem>
          <StepNumber>1</StepNumber>
          <ListItemExplanation variant='h3'>{t('findOutMail')}</ListItemExplanation>
        </ListItem>
        <ListItem>
          <StepNumber>2</StepNumber>
          <ListItemExplanation variant='h3'>{t('sendText')}</ListItemExplanation>
        </ListItem>
