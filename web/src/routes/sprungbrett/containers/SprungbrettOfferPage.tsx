...
const Image: StyledComponent<{}, ThemeType, any> = styled.img`
  display: block;
  margin: 0 auto;
`;
type PropsType = {
...
export class SprungbrettOfferPage extends React.Component<PropsType> {
  renderSprungbrettListItem = (job: SprungbrettJobModel): React.ReactNode => <SprungbrettListItem key={job.id} job={job} />;
  ...
  render() {
    ...
    return <>
        ...
        <List noItemsMessage={t('noOffersAvailable')} renderItem={this.renderSprungbrettListItem} items={sprungbrettJobs} />
