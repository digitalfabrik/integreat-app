...
const StyledTab: StyledComponent<{}, ThemeType, any> = styled(NewsLink)`
  display: flex;
  width: 160px;
  height: 50px;
...
`;
const TuStyledTab: StyledComponent<{}, ThemeType, any> = styled(StyledTab)`
  background-image: ${({
  active,
  theme
...
class Tab extends React.PureComponent<PropsType> {
  render() {
    ...
    return <StyledTab active={active} to={destination}>
        {t('local').toUpperCase()}
      </StyledTab>;
  }
