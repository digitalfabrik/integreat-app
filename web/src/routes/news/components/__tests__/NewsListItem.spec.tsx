...
jest.mock('../../../../modules/common/components/LastUpdateInfo', () => jest.fn(({
  lastUpdate,
  withText
}) => <div>
      {withText ? 'lastUpdate ' : ''}
