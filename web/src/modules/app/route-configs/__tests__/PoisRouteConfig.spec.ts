...
const pois = [new PoiModel({
  ...
  title: 'Erster Poi',
  availableLanguages: new Map([['en', '/augsburg/en/locations/first_poi'], ['ar', '/augsburg/ar/locations/erster_poi']]),
...
describe('PoisRouteConfig', () => {
  ...
  it('should get the right path', () => {
    expect(poisRouteConfig.getRoutePath({
      city: 'augsburg',
      language: 'de'
  ...
  describe('get language change path should return the right path if', () => {
    it('is the pois root page', () => {
      ...
      expect(poisRouteConfig.getLanguageChangePath({
        payloads,
        language: 'en',
        location
  ...
  describe('get the right page title if', () => {
    it('an poi with the given pathname does exist', () => {
      ...
      expect(poisRouteConfig.getPageTitle({
        payloads,
        location,
        cityName: 'Augsburg',
        t
  ...
  it('should return the right feedback target information', () => {
    ...
    expect(poisRouteConfig.getFeedbackTargetInformation({
      payloads,
      location
    })).toEqual({
      path: '/augsburg/de/locations/erster_poi'
