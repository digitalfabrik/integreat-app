...
describe('OffersRouteConfig', () => {
  ...
  it('should get the right path', () => {
    expect(extasRouteConfig.getRoutePath({
      city: 'augsburg',
      language: 'de'
    })).toBe('/augsburg/de/offers');
  });
  ...
  it('should get the right language change path', () => {
    ...
    expect(extasRouteConfig.getLanguageChangePath({
      payloads,
      language: 'en',
      location
  ...
  it('should get the right page title', () => {
    ...
    expect(extasRouteConfig.getPageTitle({
      payloads,
      location,
      cityName: 'Augsburg',
      t
  ...
  it('should return the right feedback target information', () => {
    ...
    expect(extasRouteConfig.getFeedbackTargetInformation({
      payloads,
      location
    })).toBeNull();
  });
