...
const payloads = {
  ...
  sprungbrettJobs: sprungbrettJobsPayload
};
...
describe('SprungbrettRouteConfig', () => {
  ...
  it('should get the right path', () => {
    expect(sprungbrettRouteConfig.getRoutePath({
      city: 'augsburg',
      language: 'de'
  ...
  it('should get the right language change path', () => {
    ...
    expect(sprungbrettRouteConfig.getLanguageChangePath({
      payloads,
      language: 'en',
      location
  ...
  it('should get the right page title', () => {
    ...
    expect(sprungbrettRouteConfig.getPageTitle({
      payloads,
      location,
      cityName: 'Augsburg',
      t
  ...
  it('should return the right feedback target information', () => {
    ...
    expect(sprungbrettRouteConfig.getFeedbackTargetInformation({
      payloads,
      location
    })).toEqual({
      alias: 'sprungbrett'
