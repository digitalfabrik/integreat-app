...
const events = [new EventModel({
  ...
  title: 'Erstes Event',
  availableLanguages: new Map([['en', '/augsburg/en/events/first_event'], ['ar', '/augsburg/ar/events/erstes_event']]),
  date: new DateModel({
...
describe('EventsRouteConfig', () => {
  ...
  it('should get the right path', () => {
    expect(eventsRouteConfig.getRoutePath({
      city: 'augsburg',
      language: 'de'
  ...
  describe('get language change path should return the right path if', () => {
    it('is the events root page', () => {
      ...
      expect(eventsRouteConfig.getLanguageChangePath({
        payloads,
        language: 'en',
        location
  ...
  describe('get the right page title if', () => {
    it('an event with the given pathname does exist', () => {
      ...
      expect(eventsRouteConfig.getPageTitle({
        payloads,
        location,
        cityName: 'Augsburg',
        t
