...
const payloads = {
  ...
  wohnenOffers: wohnenOffersPayload
};
...
describe('WohnenRouteConfig', () => {
  ...
  it('should get the right path', () => {
    expect(wohnenRouteConfig.getRoutePath({
      city: 'augsburg',
      language: 'de'
  ...
  it('should get the right language change path', () => {
    ...
    expect(wohnenRouteConfig.getLanguageChangePath({
      payloads,
      language: 'en',
      location
  ...
  it('should get the right page title', () => {
    ...
    expect(wohnenRouteConfig.getPageTitle({
      payloads,
      location,
      cityName: 'Augsburg',
      t
  ...
  it('should return the right feedback target information', () => {
    ...
    expect(wohnenRouteConfig.getFeedbackTargetInformation({
      payloads,
      location
    })).toEqual({
      alias: 'wohnen'
