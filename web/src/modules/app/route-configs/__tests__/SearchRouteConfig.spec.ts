...
describe('SearchRouteConfig', () => {
  ...
  it('should get the right path', () => {
    expect(searchRouteConfig.getRoutePath({
      city: 'augsburg',
      language: 'de'
  ...
  it('should get the right language change path', () => {
    ...
    expect(searchRouteConfig.getLanguageChangePath({
      payloads,
      language: 'en',
      location
  ...
  it('should get the right page title', () => {
    ...
    expect(searchRouteConfig.getPageTitle({
      payloads,
      location,
      cityName: 'Augsburg',
      t
  ...
  describe('it should return the right feedback target information', () => {
    ...
    expect(searchRouteConfig.getFeedbackTargetInformation({
      payloads,
      location
    })).toBeNull();
  });
