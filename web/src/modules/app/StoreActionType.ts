...
export type StoreActionType = StartFetchActionType<any> | FinishFetchActionType<any, any> | SetLanguageActionType | SetCurrentCityActionType | SetUiDirectionActionType | ToggleDarkModeActionType;