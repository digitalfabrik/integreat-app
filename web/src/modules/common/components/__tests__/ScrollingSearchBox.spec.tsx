...
describe('ScrollingSearchBox', () => {
  ...
  it('should render', () => {
    const component = <ScrollingSearchBox filterText='Test' placeholderText='Placeholder' onFilterTextChange={() => {}} onStickyTopChanged={onStickyTopChanged}>
        <MockNode />
      </ScrollingSearchBox>;
    expect(shallow(component)).toMatchSnapshot();
  });
  it('should space search', () => {
    expect(shallow(<ScrollingSearchBox filterText='Test' placeholderText='Placeholder' onFilterTextChange={() => {}} spaceSearch onStickyTopChanged={onStickyTopChanged}>
          <MockNode />
  ...
  it('should pass onFilterTextChange and onStickyTopChanged', () => {
    ...
    const component = mount(<ThemeProvider theme={theme}>
        <ScrollingSearchBox filterText='Test' placeholderText='Placeholder' onFilterTextChange={outerFilterTextChange} onStickyTopChanged={outerStickyTopChanged}>
          <MockNode />
        </ScrollingSearchBox>
  ...
  it('should set correct reference', () => {
    const component = mount(<ThemeProvider theme={theme}>
        <ScrollingSearchBox filterText='Test' onFilterTextChange={() => {}} placeholderText='Placeholder' onStickyTopChanged={onStickyTopChanged}>
          <MockNode />
        </ScrollingSearchBox>
      </ThemeProvider>).find(ScrollingSearchBox);
