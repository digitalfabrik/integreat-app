...
class RemoteContent extends React.Component<PropsType> {
  ...
  constructor() {
    super();
    this.sandBoxRef = React.createRef<any>();
  }
  ...
  render() {
    return <SandBox centered={this.props.centered} dangerouslySetInnerHTML={this.props.dangerouslySetInnerHTML} ref={this.sandBoxRef} />;
  }
