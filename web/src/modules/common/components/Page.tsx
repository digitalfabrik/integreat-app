...
type PropsType = {
  ...
  thumbnailSrcSet?: string | null | undefined;
  content: string;
  lastUpdate?: Moment;
...
const Page = ({
  ...
  return <>
      ...
      <Caption title={title} />
      {children}
      <RemoteContent dangerouslySetInnerHTML={{
      __html: content
    }} onInternalLinkClick={onInternalLinkClick} />
      {lastUpdate && <LastUpdateInfo lastUpdate={lastUpdate} format={lastUpdateFormat} formatter={formatter} withText={showLastUpdateText} />}
    </>;
};
