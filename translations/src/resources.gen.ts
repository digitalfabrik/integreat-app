...
const resources = {
  ...
  "tour": {
    ...
    "finish": "Finish",
    "finishTitle": "Done!",
    "finishDescription": "Now you know the most important features. Good luck with {{appName}}!",
    "finishAction": "Let's go",
    "changeLocationTitle": "Change location",
    "changeLocationDescription": "Select your <strong>city</strong> here to find local information.",
    "navigationTitle": "Navigation",
    "navigationDescription": "Switch between <strong>Information</strong>, <strong>Map</strong>, <strong>News</strong> and <strong>Events</strong> here.",
    "categoriesTitle": "Discover topics",
    "categoriesDescription": "Discover information on topics such as <strong>Housing</strong>, <strong>Education</strong>, <strong>Work</strong> and more.",
    "searchAndLanguageTitle": "Language and search",
    "searchAndLanguageDescription": "Search for topics or change the language.",
    "additionalFeaturesTitle": "Additional features",
    "additionalFeaturesDescription": "Use further features here such as <strong>creating a PDF</strong>, <strong>reading aloud</strong>, <strong>sharing</strong> and <strong>high contrast</strong>.",
    "additionalFeaturesWithFeedbackDescription": "Use further features here such as <strong>creating a PDF</strong>, <strong>reading aloud</strong>, <strong>giving feedback</strong>, <strong>sharing</strong> and more.",
    "chatDescription": "Ask your questions here and quickly get suitable answers.",
    "feedbackTitle": "Give feedback",
    "feedbackDescription": "We are happy to receive your feedback. Tell us what you like and what we can do better."
  }
} as const
