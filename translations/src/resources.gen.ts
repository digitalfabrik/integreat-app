...
const resources = {
  ...
  "tour": {
    ...
    "searchAndLanguageTitle": "Search and language",
    "searchAndLanguageDescription": "<strong>Search</strong> for topics, events and places or change the <strong>language</strong>.",
