...
describe('SearchFeedback', () => {
  ...
  it('should render a NothingFoundFeedbackBox if no results are found', () => {
    expect(shallow(
      <SearchFeedback cityCode={cityCode} languageCode={languageCode} query='abc' resultsFound={false} />)
    ).toMatchSnapshot()
  })
  ...
  it('should render neither a NothingFoundFeedbackBox nor a FeedbackButton', () => {
    expect(shallow(
      <SearchFeedback cityCode={cityCode} languageCode={languageCode} query='' resultsFound />
    )).toMatchSnapshot()
  })
})
