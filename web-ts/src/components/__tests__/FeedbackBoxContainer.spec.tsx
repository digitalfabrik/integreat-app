...
import { CATEGORIES_FEEDBACK_TYPE, EVENTS_FEEDBACK_TYPE, OFFER_FEEDBACK_TYPE, OFFERS_FEEDBACK_TYPE, PAGE_FEEDBACK_TYPE, SPRUNGBRETT_OFFER } from "api-client";
...
describe('FeedbackBoxContainer', () => {
  ...
  `('should successfully request feedback for $feedbackType', async ({
    routeType,
    inputProps,
    feedbackType
  }) => {
