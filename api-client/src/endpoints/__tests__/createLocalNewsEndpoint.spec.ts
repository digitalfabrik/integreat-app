...
describe('localnews', () => {
  ...
  const itemModel1 = createNewsItemModel(DateTime.fromJSDate(new Date('2020-03-20 17:50:00'), { zone: 'GMT' }))
  const itemModel2 = createNewsItemModel(DateTime.fromJSDate(new Date('2020-05-20 15:00:00'), { zone: 'GMT' }))
  const itemModel3 = createNewsItemModel(DateTime.fromJSDate(new Date('2019-07-20 00:00:00'), { zone: 'GMT' }))
  const params = {
    city: 'testumgebung',
    language: 'en',
    count: 1,
