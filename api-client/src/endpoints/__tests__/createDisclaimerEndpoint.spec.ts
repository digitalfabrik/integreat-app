...
describe('disclaimer', () => {
  ...
  const disclaimerModel = new PageModel({
    path: '/augsburg/en/disclaimer/feedback-contact-and-opportunities-to-take-part',
  ...
  it('should map fetched data to models', () => {
    ...
    expect(disclaimerModel).toEqual(disclaimerModel)
  })

  it('should sanitize html', () => {
    const json = { ...pageJson, content: '<a><script>alert("XSSS");</script>Ich bleib aber da.</a>' }
    expect(disclaimer.mapResponse(json, params)).toEqual(disclaimerModel)
  })
})
