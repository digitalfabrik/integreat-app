...
describe('PoiModel', () => {
  ...
  it('should return geo location', () => {
    expect(poi[0]!.getMapPoi()).toEqual(expectedGeoJsonPoiFeature)
  })

  it('should return geo location with distance', () => {
    expect(poi[0]!.getMapPoi(poi[0]!.location.coordinates)).toEqual({ ...expectedGeoJsonPoiFeature, distance: '0.0' })
  })
