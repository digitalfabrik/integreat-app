...
class Extras extends React.Component<PropsType> {
  ...
  navigateToFeedback = (isPositiveFeedback: boolean) => {
    ...
    const feedbackItems = [
      createFeedbackVariant(t('feedback:contentOfCity', { city: cityTitle }), EXTRAS_FEEDBACK_TYPE, CONTENT_FEEDBACK_CATEGORY),
      ...extras.map(extra =>
        createFeedbackVariant(t('feedback:contentOfExtra', { extra: extra.title }), EXTRA_FEEDBACK_TYPE, CONTENT_FEEDBACK_CATEGORY, extra.alias)
      ),
