...
export {default as categoriesEndpoint} from './endpoints/createCategoriesEndpoint'
export {default as citiesEndpoint} from './endpoints/createCitiesEndpoint'
export {default as disclaimerEndpoint} from './endpoints/createDisclaimerEndpoint'
export {default as eventsEndpoint} from './endpoints/createEventsEndpoint'
export {default as extrasEndpoint} from './endpoints/createExtrasEndpoint'
export {default as feedbackEndpoint} from './endpoints/createFeedbackEndponit'
...
export {default as languagesEndpoint} from './endpoints/createLanguagesEndpoint'
export {default as poisEndpoint} from './endpoints/createPOIsEndpoint'
export {default as sprungbrettEndpoint} from './endpoints/createSprungbrettJobsEndpoint'
export {default as wohnenEndpoint} from './endpoints/createWohnenEndpoint'
