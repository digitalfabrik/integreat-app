  ...
  it('should match snapshot', () => {
    const component = shallow(
      <HeaderNavigationBar className='testClass'>
        <HeaderNavigationItem href='/random_route' text='text1' active icon='icon1' />
        <HeaderNavigationItem href='/another_route' text='text2' icon='icon2' active={false} tooltip='tooltip1' />
      </HeaderNavigationBar>
    )
