...
class DisclaimerRouteConfig implements RouteConfigInterface<DisclaimerRouteParamsType, RequiredPayloadsType> {
  ...
  getPageTitle = ({t, cityName}: GetPageTitleParamsType) =>
