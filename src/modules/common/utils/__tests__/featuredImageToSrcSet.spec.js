...
describe('featuredImageToSrcSet', () => {
  it('should calculate the correct sizes for srcSet', () => {
    const srcSet = featuredImageToSrcSet(new FeaturedImageModel({
    ...
    expect(srcSet).toEqual('thumbnail 0.5x, medium 1x, large 1.5x, full 2x')
  })
})
