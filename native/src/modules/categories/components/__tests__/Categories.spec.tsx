...
describe('Categories', () => {
  it('should pass an empty object to Page if the resource cache doesnt contain an appropriate entry', () => {
    ...
    const result = TestRenderer.create(<Categories cityModel={cityModel} language={languages[0].code} stateView={stateView} navigateTo={() => {}} navigateToFeedback={() => {}} resourceCacheUrl='http://localhost:8080' navigateToLink={() => {}} resourceCache={{
      notAvailable: {}
    }} theme={lightTheme} />);
