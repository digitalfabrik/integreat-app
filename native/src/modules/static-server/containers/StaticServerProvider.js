...
type DispatchPropsType = {| setResourceCacheUrl: string => void |}
...
class StaticServerProvider extends React.Component<PropsType, {| errorMessage: string | null |}> {
    staticServer = new StaticServer(8080, SERVER_PATH, {localOnly: true})
