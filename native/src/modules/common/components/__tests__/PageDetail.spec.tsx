...
describe('PageDetail', () => {
  it('should display the given identifier followed by a colon', () => {
    const {
      queryAllByText,
      queryByText
    } = render(<PageDetail identifier='Test Identifier' information='Some important information' theme={lightTheme} language='de' />);
  ...
  describe('should manually reverse if content language doesnt have the same direction as system language', () => {
    it('if system language is not rtl', () => {
      ...
      const {
        queryAllByText: queryAllByTextReverse
      } = render(<PageDetail identifier='Test Identifier' information='Some important information' theme={lightTheme} language='ar' />);
