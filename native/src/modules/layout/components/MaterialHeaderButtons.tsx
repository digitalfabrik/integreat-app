...
const MaterialHeaderButtons = (props: {
  ...
  return <HeaderButtons HeaderButtonComponent={MaterialHeaderButton} OverflowIcon={<MaterialIcon name='more-vert' size={23} color={theme.colors.textColor} />} onOverflowMenuPress={onOverflowMenuPress(cancelLabel)} {...otherProps} />;
};
