...
import { CATEGORIES_FEEDBACK_TYPE, CATEGORIES_ROUTE, CONTENT_FEEDBACK_CATEGORY, SEND_FEEDBACK_SIGNAL_NAME } from "api-client";
...
describe('FeedbackContainer', () => {
  ...
  it('should send feedback request on submit', async () => {
    const {
      getByText,
      findByText
    } = render(<FeedbackContainer routeType={CATEGORIES_ROUTE} isPositiveFeedback isSearchFeedback={false} language={language} cityCode={city} theme={buildConfig().lightTheme} />);
