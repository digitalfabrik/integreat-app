...
import type { PropsType as PoisPropsType } from "../components/Pois";
...
const ThemedTranslatedPois = withTranslation<$Diff<PoisPropsType, {
  theme: ThemeType;
...
class PoisContainer extends React.Component<ContainerPropsType> {
  ...
  render() {
    ...
    return <ThemedTranslatedPois {...rest} navigateTo={createNavigate(dispatch, navigation)} navigateToFeedback={createNavigateToFeedbackModal(navigation)} navigateToLink={this.navigateToLinkProp} />;
  }
...
export default connect<PropsType, OwnPropsType, _, _, _, _>(mapStateToProps, mapDispatchToProps)(withPayloadProvider<ContainerPropsType, RefreshPropsType, PoisRouteType>(refresh, onRouteClose)(PoisContainer));