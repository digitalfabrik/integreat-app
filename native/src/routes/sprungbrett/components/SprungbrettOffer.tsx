...
const SprungbrettOffer = ({
  ...
  const renderListItem = useCallback((job: SprungbrettJobModel): React.ReactNode => <SprungbrettListItem key={job.id} job={job} openJobInBrowser={openJob(job.url)} theme={theme} language={language} />, [language, theme, openJob]);
  return <>
