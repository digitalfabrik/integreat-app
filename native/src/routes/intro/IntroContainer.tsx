...
import type { SlideContentType } from "./SlideContent";
...
class Intro extends React.Component<PropsType, StateType> {
  ...
  render() {
    ...
    return <Container width={width}>
        <FlatList ref={this._flatList} data={this.slides()} horizontal pagingEnabled viewabilityConfig={{
        itemVisiblePercentThreshold: 51,
        minimumViewTime: 0.1
      }} onViewableItemsChanged={this.onViewableItemsChanged} showsHorizontalScrollIndicator={false} bounces={false} renderItem={this.renderSlide} />
        <SlideFooter slideCount={slideCount} onDone={this.onDone} currentSlide={currentSlide} goToSlide={this.goToSlide} theme={theme} t={t} />
      </Container>;
  }
...
export default connect<ConnectType, OwnPropsType, _, _, _, _>(mapStateToProps)(withTranslation<$Diff<PropsType, {
  theme: ThemeType;
