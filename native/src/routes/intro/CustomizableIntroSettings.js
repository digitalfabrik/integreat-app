...
class CustomizableIntroSettings extends React.Component<PropsType> {
  render() {
    const {
      ...
      toggleSetAllowPushNotifications,
      proposeNearbyCities,
      toggleProposeNearbyCities,
      errorTracking,
      toggleErrorTracking
    } = this.props
    ...
    return (
      <>
        <SettingItem
          ...
          onPress={toggleSetAllowPushNotifications}
          theme={theme}>
          <Switch
        ...
        <SettingItem
          bigTitle
          title={t('settings:proposeCitiesTitle')}
          description={t('settings:proposeCitiesDescription')}
          onPress={toggleProposeNearbyCities}
          theme={theme}>
          <Switch
            thumbColor={themeColor}
            trackColor={{ true: themeColor }}
            value={proposeNearbyCities}
