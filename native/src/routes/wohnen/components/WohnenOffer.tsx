...
class WohnenOffer extends React.Component<PropsType> {
  renderOfferListItem = (offer: WohnenOfferModel) => {
    ...
    return <OfferListItem key={hashedOffer} offer={offer} language={this.props.language} navigateToOffer={this.navigateToOffer(hashedOffer)} theme={this.props.theme} />;
  };
  ...
  render() {
    ...
    return <>
        ...
        <List noItemsMessage={t('noOffersAvailable')} items={offers} renderItem={this.renderOfferListItem} theme={theme} />
      </>;
  }
