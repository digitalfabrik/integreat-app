...
class ThemedSearchBar extends React.Component<PropsType> {
  render() {
    ...
    return <SearchBar accessibilityRole='search' allowFontScaling={false} containerStyle={{
      flexGrow: 1,
      ...
      backgroundColor: colors.backgroundColor
    }} onChangeText={onChangeText} value={value} autoFocus={autofocus} placeholder={t('searchPlaceholder')} />;
  }
