...
const ExternalOffer = (props: PropsType) => {
  ...
  return <WebView source={postData ? createPostSource(url, body) : createGetSource(url, body)} javaScriptEnabled dataDetectorTypes='none' domStorageEnabled={false} ref={webviewRef}
  ...
  cacheEnabled={false} renderError={renderWebviewError} onNavigationStateChange={onNavigationStateChange} />;
};
