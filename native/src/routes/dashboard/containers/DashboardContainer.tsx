...
const ThemedTranslatedDashboard = withTranslation<$Diff<DashboardPropsType, {
  theme: ThemeType;
...
const DashboardContainer = (props: ContainerPropsType) => {
  ...
  return <ThemedTranslatedDashboard {...rest} navigateToFeedback={createNavigateToFeedbackModal(navigation)} navigateToLink={navigateToLinkProp} navigateTo={createNavigate(dispatch, navigation)} />;
};

export default connect<PropsType, OwnPropsType, _, _, _, _>(mapStateToProps, mapDispatchToProps)(withPayloadProvider<ContainerPropsType, RefreshPropsType, DashboardRouteType>(refresh)(DashboardContainer));