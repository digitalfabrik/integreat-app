  ...
  return <View style={{
    flex: 1
      ...
      paddingHorizontal: '5%'
        ...
        {newsItem instanceof TunewsModel && <HeaderImageWrapper>
        ...
        <Container>
          ...
          <Html source={{
          html: content
        }} contentWidth={width} onLinkPress={onLinkPress} baseFontStyle={{
          ...
          {newsItem instanceof LocalNewsModel && <TimeStampContent language={language} theme={theme}>
              <TimeStamp formatter={formatter} lastUpdate={newsItem.timestamp} showText={false} format={'LLL'} language={language} theme={theme} />
            </TimeStampContent>}
        </Container>
      </ScrollView>
    </View>;
