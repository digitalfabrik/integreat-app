...
describe('NewsDetail', () => {
  ...
  it('should correctly render a local news item', () => {
    ...
    const {
      getByText,
      queryByText
    } = render(<NewsDetail newsItem={localNews} language={language} navigateToLink={navigateToLink} theme={theme} />);
  ...
  it('should correctly render a tu news item', () => {
    const {
      getByText,
      queryByText
    } = render(<NewsDetail newsItem={tuNews} language={language} navigateToLink={navigateToLink} theme={theme} />);
  ...
  it('should correctly render a tu news item link', () => {
    ...
    expect(navigateToLink).toHaveBeenCalledWith('https://tunewsinternational.com/category/corona-deutsch/', language, 'https://tunewsinternational.com/category/corona-deutsch/');
  });
});