...
describe('NewsListItem', () => {
  ...
  it('should correctly render a local news item', () => {
    const {
      getByText,
      queryByText
    } = render(<NewsListItem newsItem={localNews} language={language} navigateToNews={navigateToNews} theme={buildConfig().lightTheme} t={t} isTunews={false} />);
  ...
  it('should correctly render a tu news item', () => {
    const {
      getByText
    } = render(<NewsListItem newsItem={tuNews} language={language} navigateToNews={navigateToNews} theme={buildConfig().lightTheme} t={t} isTunews />);
