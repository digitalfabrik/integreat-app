...
class Landing extends React.Component<PropsType, StateType> {
  ...
  render() {
    ...
    return <Wrapper>
        ...
        <FilterableCitySelector theme={theme} cities={cities} t={t} location={location} retryDetermineLocation={retryDetermineLocation} navigateToDashboard={this.navigateToDashboard} />
      </Wrapper>;
  }
