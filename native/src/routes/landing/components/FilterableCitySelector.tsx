...
class FilterableCitySelector extends React.Component<PropsType, StateType> {
  ...
  onFilterTextChange = (filterText: string) => this.setState({
    filterText
  });
  ...
  render() {
    ...
    return <View>
        <SearchBar>
          <SearchInput filterText={filterText} onFilterTextChange={this.onFilterTextChange} placeholderText={t('searchCity')} spaceSearch={false} theme={theme} />
        </SearchBar>
