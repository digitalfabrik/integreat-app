...
export const Input: StyledComponent<{}, ThemeType, any> = styled.TextInput.attrs((props: {
  theme: ThemeType;
}) => ({
  multiline: false,
...
class SearchInput extends React.Component<PropsType> {
  ...
  render() {
    ...
    return <Wrapper theme={theme} space={spaceSearch}>
        <SearchIcon theme={theme} />
        <Input {...testID('Search-Input')} theme={theme} placeholder={placeholderText} aria-label={placeholderText} defaultValue={filterText} onChangeText={this.onFilterTextChange} onClick={onClickInput} />
      </Wrapper>;
  }
