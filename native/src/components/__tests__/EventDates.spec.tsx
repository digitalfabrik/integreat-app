...
describe('EventDates', () => {
  ...
  it('should render the upcoming date row for a non-recurring event', () => {
    ...
    const { getByText, queryByText } = render(<EventDates event={event} language={language} size='small' />)
  ...
  it('should render the next recurrence as the upcoming date for a recurring event', () => {
    ...
    const { getByText } = render(<EventDates event={event} language={language} size='small' />)
