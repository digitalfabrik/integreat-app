...
export type GeoJsonPlaceProperties = {
  places: GeoJsonPlace[]
}
...
export type MapFeature = Feature<Point, GeoJsonPlaceProperties> & {
  layer: {
    id: string
  }
}
...
export const mapConfig: MapConfigProps = {
  ...
  rtlPluginUrl: '/plugins/mapbox-gl-rtl-text-0.4.0.min.js',
}
