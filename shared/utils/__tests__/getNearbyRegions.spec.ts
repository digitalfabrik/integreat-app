...
describe('getNearbyRegions', () => {
  ...
  it('should return first nearby cities sorted by distance', () => {
    ...
    expect(getNearbyRegions([longitude, latitude], cities)).toEqual([exactCity, closeAliasCity, closeCity])
  })
  ...
  it('should not return cities outside of distance threshold', () => {
    ...
    expect(getNearbyRegions([longitude, latitude], cities)).toEqual([closeAliasCity, stillCloseCity])
  })
})
